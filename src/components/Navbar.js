...
<div className="flex gap-6 justify-center items-center">
      ...
      <div className=" navbars flex items-center justify-center">
        <ul
          ref={navref}
          className="flex justify-center gap-10 items-center text-xl text-customWhite"
        >
          <NavLink to={"/"}>
            {" "}
          ...
          <NavLink to={"/products"}>
            {" "}
            <li onClick={toggleNavbar}>projects</li>{" "}
          </NavLink>
          <NavLink to={"/contact"}>
            {" "}
            <li onClick={toggleNavbar}>Skills</li>{" "}
          </NavLink>
          <NavLink to={"/about"}>
            {" "}
